...
**This creates:** `staged-issues/RTDEV: My Epic.md`

### **Phase 2: Review and Submit**
```bash
# Edit the staged file with your preferred editor
code "staged-issues/RTDEV: My Epic.md"

# Review staged content
python3 staged_epic_creator.py submit "staged-issues/RTDEV: My Epic.md" --dry-run

# Submit when ready
python3 staged_epic_creator.py submit "staged-issues/RTDEV: My Epic.md"
```
...
python3 staged_epic_creator.py submit "staged-issues/RTDEV: Epic.md"
```

#### **Problem: "YAML parsing error"**
```bash
# Validate YAML frontmatter
python3 -c "import yaml; yaml.safe_load(open('staged-issues/RTDEV: file.md').read())"
